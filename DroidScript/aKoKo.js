...
function InitLayMain() {
    ...
    layMain.SetBackColor(CFG.app.style.backcolor);
}
...
function InitLayAbout() {
    ...
    //layAbout.SetBackground("/Sys/Img/GreenBack.png");
...
function BuildLayAbout() {
    ...
    layAbout.AddChild(Utils.Controls.CreateText("Eduardo Daniel Cuomo"));
    layAbout.AddChild(Utils.Controls.CreateText(""));
    layAbout.AddChild(Utils.Controls.CreateText("Fecha carga horarios:"));
    layAbout.AddChild(Utils.Controls.CreateText("01/02/2015"));
    layAbout.AddChild(Utils.Controls.CreateText(""));
    layAbout.AddChild(Utils.Controls.CreateText("Contacto:"));
    layAbout.AddChild(Utils.Controls.CreateText("eduardo.cuomo.ar@gmail.com"));
    layAbout.AddChild(Utils.Controls.CreateText(""));
...
function InitLayDetail() {
    ...
    //layDetail.SetBackground("/Sys/Img/GreenBack.png");
    layDetail.SetBackColor(CFG.app.style.backcolor);
