...
public class RxAndroid {
    ...
    /**
     * Main Application.
     * Saved on first use {@link #RxActivity} as Activity.
     */
    private static ContextWrapper mainApplication = null;
    ...
    public static ContextWrapper getMainApplication() {
        if (!hasMainApplication()) {
            throw new RuntimeException(RxActivity.class.getSimpleName() + " never used as activity!");
        }
